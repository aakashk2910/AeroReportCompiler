...
<html >
  <head>
    <meta charset="UTF-8">
    <title>AeroCompiler | Payment</title>
...
.customwidth{
  ...
  <body style="margin-top:10%">
    ...
    <div class="container">
        ...
        <div class="panel panel-default credit-card-box customwidth center-block">
            <div class="panel-heading display-table" >
                ₹ 500 will be debited from your A/C
            ...
            <div class="panel panel-default credit-card-box customwidth center-block">
                <div class="panel-heading display-table" >
                    <div class="row display-tr" >
                        ...
                        <div class="display-td" >                            
                            <img class="img-responsive pull-right" src="dist/img/gIMFDbp.png">
                ...
                <div class="panel-body">
                    {{ Form::open(array('url' => '/rform/'.\Illuminate\Support\Facades\Auth::user()->id, 'id' => 'payment-form' )) }}
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <button class="btn btn-success btn-lg btn-block">Make Payment</button>
                            </div>
                        </div>
    ...
    <script src="dist/js/j2.js"></script>
  </body>
</html>
